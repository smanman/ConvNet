...
def test(fold):
    path = '/home/ubuntu/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task01_ACDC'
    label_path = '/home/ubuntu/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task01_ACDC/labelsTs'
    pred_path = '/home/ubuntu/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task01_ACDC/infersTs'
    ...
    if not os.path.exists(file):
        os.makedirs(file)
    fw = open(file + '/acdc_dice_pre.txt', 'w')
