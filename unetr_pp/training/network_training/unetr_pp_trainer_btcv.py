...
from unetr_pp.network_architecture.btcv.unetr_pp_btcv import UNETR_PP
...
from unetr_pp.training.network_training.Trainer_btcv import Trainer_btcv
...
class unetr_pp_trainer_btcv(Trainer_btcv):
    """
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits[self.fold]['train'] = np.array(
                ['img0001', 'img0002', 'img0003', 'img0004', 'img0005', 'img0006', 'img0007', 'img0008', 'img0009',
                 'img0010', 'img0021', 'img0022' \
                    , 'img0023', 'img0024', 'img0025', 'img0026', 'img0027', 'img0028','img0029','img0030','img0031','img0032','img0033','img0034'])
    ...
    def maybe_update_lr(self, epoch=None):
        ...
        # self.optimizer.param_groups[0]['lr'] = TC_calc_lr(ep, self.max_num_epochs, self.initial_lr, 0.9)
