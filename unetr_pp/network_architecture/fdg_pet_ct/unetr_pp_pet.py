...
from unetr_pp.network_architecture.fdg_pet_ct.model_components_pet import UnetrPPEncoder, UnetrUpBlock
import torch.nn.functional as F


class UNETR_PP(SegmentationNetwork):
    """
    UNETR++ 模型，为FDG-PET双模态数据集优化
    基于: "Shaker et al., UNETR++: Delving into Efficient and Accurate 3D Medical Image Segmentation"
    """
