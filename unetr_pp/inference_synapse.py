...
def test(fold): 
    ...
    path = '/home/ubuntu/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task02_Synapse'
    label_path = '/home/ubuntu/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task02_Synapse/labelsTs'
    pred_path = '/home/ubuntu/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task02_Synapse/infersTs'
    ...
    if not os.path.exists(file):
        os.makedirs(file)
    fw = open(file+'/synapse_dice_pre.txt', 'a')
