...
def test(fold):
    #path='./'
    path = '/home/sys123456/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task03_tumor'
    label_path = '/home/sys123456/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task03_tumor/labelsTs'
    pred_path = '/home/sys123456/Q22301179/data/unetr_pp_Data/DATASET/unetr_pp_raw/unetr_pp_raw_data/Task03_tumor/infersTs'
    ...
    HD_ed=[]
    HD_net=[]
    # file=path + 'infersTs/'+fold
    file=path
    if not os.path.exists(file):
        os.makedirs(file)
    fw = open(file+'/tumor_dice_five.txt', 'w')
