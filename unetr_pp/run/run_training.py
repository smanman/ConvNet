...
seed = 42
# seed=3407
# seed = 1234 #lung=76.48  tumor:84.84
# seed=666  #lung=77.78 tumor:84.6
# seed=888 #lung=77.89 tumor:84.07
np.random.seed(seed)
...
def main():
    ...
    parser.add_argument("--network_trainer", default='unetr_pp_trainer_pet')
    parser.add_argument("--task", help="can be task name or task id",default='7')
    ...
    if find_lr:
        ...
        if not validation_only:
            ...
            total_training_start_time = time()
            trainer.run_training()
            total_training_end_time = time()
            total_training_time = total_training_end_time - total_training_start_time
            trainer.print_to_log_file("Total training time: %.2f seconds" % total_training_time)
        else:
            if valbest:
